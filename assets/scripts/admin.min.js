...
else if(window.opera&&window.opera.postError){window.opera.postError(msg);}}})(jQuery);$(document).ready(function(){datetimepickers();status_messages();wysihtml5_editors();tag_complete();detect_prompt_links();});jQuery.fn.dataTableExt.oSort['featured-asc']=function(x,y){ if($(x).find('i').hasClass('icon-star-empty')&&$(y).find('i').hasClass('icon-star')){return-1;} 
