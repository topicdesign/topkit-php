...
}; $.fn.wysihtml5=function(options){return this.each(function(){var $this=$(this);$this.data('wysihtml5',new Wysihtml5($this,options));})};$.fn.wysihtml5.Constructor=Wysihtml5;}(window.jQuery,window.wysihtml5));;(function($){var btn_templates={'format':'<li class="dropdown format">'
...
$('textarea[data-role="editor"]').wrap($('<div class="well"/>')).wysihtml5({events:{'focus:composer':on_focus}});}
